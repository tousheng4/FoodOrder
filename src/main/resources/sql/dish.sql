...
VALUES
    ...
    (30004, '清蒸石斑鱼', '保留鱼肉原汁原味，适合清淡口味', 'http://localhost:8080/images/30004.jpg', 68.00, 20002, 1, 0, NOW(), NOW()),
    (30005, '剁椒鱼头', '鲜辣剁椒覆盖大块鱼头，味道浓郁', 'http://localhost:8080/images/30005.jpg', 42.00, 20003, 1, 0, NOW(), NOW()),
    (30006, '小炒黄牛肉', '干香小炒牛肉，配大量辣椒与蒜片', 'http://localhost:8080/images/30006.jpg', 36.00, 20003, 1, 0, NOW(), NOW()),
    (30007, '葱烧海参', '海参口感软糯，葱香浓郁，风味独特', 'http://localhost:8080/images/30007.jpg', 88.00, 20004, 1, 0, NOW(), NOW()),
    (30008, '九转大肠', '酸甜适口的大肠，色泽红亮，入口弹牙', 'http://localhost:8080/images/30008.jpg', 52.00, 20004, 1, 0, NOW(), NOW()),
    (30009, '西湖醋鱼', '酸甜开胃，鱼肉细嫩，杭州名菜', 'http://localhost:8080/images/30009.jpg', 39.00, 20005, 1, 0, NOW(), NOW()),
    (30010, '东坡肉', '肥而不腻，入口即化，配米饭毫无压力', 'http://localhost:8080/images/30010.jpg', 45.00, 20005, 1, 0, NOW(), NOW()),
    (30011, '松鼠桂鱼', '外酥里嫩，酸甜口味，颜值与味道兼具', 'http://localhost:8080/images/30011.jpg', 58.00, 20006, 1, 0, NOW(), NOW()),
    (30012, '清炖狮子头', '肉质细腻软糯，大块肉丸配清汤', 'http://localhost:8080/images/30012.jpg', 36.00, 20006, 1, 0, NOW(), NOW()),
    (30013, '佛跳墙', '多种高档食材熬制，汤汁浓郁，鲜味十足', 'http://localhost:8080/images/30013.jpg', 98.00, 20007, 1, 0, NOW(), NOW()),
    (30014, '荔枝肉', '酸甜荔枝口感的肉块，开胃下饭', 'http://localhost:8080/images/30014.jpg', 32.00, 20007, 1, 0, NOW(), NOW()),
    (30015, '臭鳜鱼', '外皮焦香，鱼肉细嫩，闻起来重口吃起来上头', 'http://localhost:8080/images/30015.jpg', 58.00, 20008, 1, 0, NOW(), NOW()),
